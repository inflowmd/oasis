...
const steps: Step[] = [
  ...
  {
    n: "2",
    title: (<>In-Depth Review &amp; <span className="fdi" style={{ color: "var(--gm)", fontSize: "1.25em" }}>Your Plan</span></>),
      ...
      <div className="mx">
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <h2 className="fd" style={{ fontSize: "clamp(30px,3vw,46px)", fontWeight: 700, color: "var(--td)" }}>
            Three steps to your <span className="fdi" style={{ color: "var(--gm)", fontSize: "1.25em" }}>longevity program.</span>
          </h2>
        </div>
        {steps.map((s) => {
          const text = (
            <div className="hiw-text">
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                ...
                >
                  <span className="fd" style={{ fontSize: 18, fontWeight: 700, color: "var(--gold)" }}>
                    {s.n}
                  </span>
                </div>
                <div
              ...
              <h3 className="fd hiw-title" style={{ fontSize: 26, fontWeight: 700, color: "var(--td)", marginBottom: 14 }}>{s.title}</h3>
